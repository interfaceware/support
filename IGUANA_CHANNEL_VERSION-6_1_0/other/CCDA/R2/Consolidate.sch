...
<sch:schema xmlns:voc="http://www.lantanagroup.com/voc" xmlns:svs="urn:ihe:iti:svs:2008" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:cda="urn:hl7-org:v3" xmlns:sdtc="urn:hl7-org:sdtc" xmlns="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
  ...
  <sch:phase id="errors">
    <sch:active pattern="p-consolidaton-document-header" />
  ...
  <sch:pattern id="p-consolidaton-document-header">
    <sch:rule id="p-consolidaton-document-header-errors-abstract" abstract="true">
      <sch:assert id="a-doc-header-check" test="cda:ClinicalDocument[count(cda:templateId[@root='2.16.840.1.113883.10.20.22.1.1'])=1]">
        In order to validate this file against the Consolidated CDA templates, it must conform to the US Realm Clinical Document Header. The ClinicalDocument SHALL contain exactly one [1..1] templateId, such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.22.1.1".
      </sch:assert>
    </sch:rule>
    <sch:rule id="p-consolidaton-document-header-errors" context="/">
      <sch:extends rule="p-consolidaton-document-header-errors-abstract" />
    </sch:rule>
  </sch:pattern>
...
SHALL contain exactly one [1..1] effectiveTime (CONF:7288).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.22.4.30-errors">
    <sch:rule id="r-2.16.840.1.113883.10.20.22.4.30-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-10085-c" test="count(cda:statusCode[@code='completed'])=0 or (count(cda:statusCode[@code='completed'])=1 and count(cda:effectiveTime[cda:high])=1)">If statusCode/@code="completed" Completed, then effectiveTime SHALL contain [1..1] high (CONF:10085).</sch:assert>
...
SHALL contain exactly one [1..1] effectiveTime (CONF:9030).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.22.1.2-errors">
    <sch:rule id="r-2.16.840.1.113883.10.20.22.1.2-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-9536-i" test="count(cda:component/cda:structuredBody)">The component/structuredBody SHALL conform to the section constraints below (CONF:9536).</sch:assert>
      <sch:assert id="a-9445-i" test="count(//cda:section/cda:templateId[@root='2.16.840.1.113883.10.20.22.2.6.1'])=1">SHALL contain exactly one [1..1] Allergies Section(entries required) (templateId:2.16.840.1.113883.10.20.22.2.6.1) (CONF:9445).</sch:assert>
      <sch:assert id="a-9447-i" test="count(//cda:section/cda:templateId[@root='2.16.840.1.113883.10.20.22.2.1.1'])=1">SHALL contain exactly one [1..1] Medications Section (entries required) (templateId:2.16.840.1.113883.10.20.22.2.1.1) (CONF:9447).</sch:assert>
      <sch:assert id="a-9449-i" test="count(//cda:section/cda:templateId[@root='2.16.840.1.113883.10.20.22.2.5.1'])=1">SHALL contain exactly one [1..1] Problem Section (entries required) (templateId:2.16.840.1.113883.10.20.22.2.5.1) (CONF:9449).</sch:assert>
      <sch:assert id="a-9453-i" test="count(//cda:section/cda:templateId[@root='2.16.840.1.113883.10.20.22.2.3.1'])=1">SHALL contain exactly one [1..1] Results Section (entries required) (templateId:2.16.840.1.113883.10.20.22.2.3.1) (CONF:9453).</sch:assert>
...
SHALL contain exactly one [1..1] effectiveTime (CONF:14445).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.22.1.1-warnings">
    <sch:rule id="r-2.16.840.1.113883.10.20.22.1.1-warnings-abstract" abstract="true">
      ...
      <sch:assert id="a-10413-c" test="not(cda:recordTarget/cda:patientRole/cda:patient/cda:guardian) or cda:recordTarget/cda:patientRole/cda:patient/cda:guardian/cda:addr[cda:streetAddressLine and cda:city and ((not(cda:country) or cda:country!='US') or (cda:country='US' and cda:state and cda:postalCode))]">The content of addr SHALL be a conformant US Realm Address (AD.US.FIELDED) (2.16.840.1.113883.10.20.22.5.2) (CONF:10413).</sch:assert>
      ...
      <sch:assert id="a-16873-c" test="not(cda:legalAuthenticator) or string-length(cda:legalAuthenticator/cda:time//@value)&gt;=8">The content SHALL be a conformant US Realm Date and Time (DTM.US.FIELDED) (2.16.840.1.113883.10.20.22.5.4) (CONF:16873).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.22.1.2-warnings">
    <sch:rule id="r-2.16.840.1.113883.10.20.22.1.2-warnings-abstract" abstract="true">
      ...
      <sch:assert id="a-10027-c" test="not(cda:documentationOf/cda:serviceEvent/cda:performer/cda:assignedEntity) or cda:documentationOf/cda:serviceEvent/cda:performer/cda:assignedEntity/cda:id[@root='2.16.840.1.113883.4.6']">SHOULD include zero or one [0..1] id where id/@root ="2.16.840.1.113883.4.6" National Provider Identifier (CONF:10027).</sch:assert>
    </sch:rule>
...
SHOULD contain zero or one [0..1] performer="PRF" Performer (CodeSystem: HL7ParticipationType 2.16.840.1.113883.5.90 STATIC) (CONF:8961) such that it SHALL contain exactly one [1..1] assignedEntity (CONF:8962). This assignedEntity SHALL contain exactly one [1..1] code (CONF:8968). This code SHALL contain exactly one [1..1] @code="GUAR" Guarantor (CodeSystem: RoleCode 2.16.840.1.113883.5.111 STATIC) (CONF:16096). SHALL contain exactly one [1..1] templateId (CONF:16810). This templateId SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.22.4.88" Guarantor Performer (CONF:16811).</sch:assert>
      ...
      <sch:assert id="a-10481-c" test="not(cda:performer[@typeCode][cda:templateId[@root='2.16.840.1.113883.10.20.22.4.87']]/cda:assignedEntity/cda:addr) or cda:performer[@typeCode][cda:templateId[@root='2.16.840.1.113883.10.20.22.4.87']]/cda:assignedEntity/cda:addr[cda:streetAddressLine and cda:city and ((not(cda:country) or cda:country!='US') or (cda:country='US' and cda:state and cda:postalCode))]">The content of addr SHALL be a conformant US Realm Address (AD.US.FIELDED) (2.16.840.1.113883.10.20.22.5.2) (CONF:10481).</sch:assert>
